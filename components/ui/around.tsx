//Source: https://toggles.dev/toggles/around
        ...
        <defs>
          ...
          >
            <path
              ...
              className="transition-[d,translate] [transition-duration:calc(var(--toggles-around--duration)_*_0.6)] [transition-timing-function:ease] dark:[transition-duration:var(--toggles-around--duration)] dark:[d:path('M-12_-14h42v30a1_1_0_00-16_13H0Z')] dark:not-supports-[d:path('M0_0')]:-translate-x-[12px] dark:not-supports-[d:path('M0_0')]:-translate-y-[14px]"
            />
          </clipPath>
        </defs>
